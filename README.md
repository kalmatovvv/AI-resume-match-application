...
- The embedding dimension in `init.sql` is set to 1536 (OpenAI text-embedding-3-small). Adjust if using a different model.
- Bedrock Titan embeddings use 1536 dimensions.
